...
{
    public class AssignEmployeeToEmployeeShiftCommandValidator : AbstractValidator<AssignEmployeeToEmployeeShiftCommand>
    {
        public AssignEmployeeToEmployeeShiftCommandValidator()
        {
            Configure();
        }
